...
<script> <!-- 아직 안고침 -->
	function selChange() {
		...
		location.href="myLectureSubList.do?nowPage=${paging.nowPage}&cntPerPage="+sel;
	}
</script>
<body>
	...
	<table style="text-align: center; width: 100%" border="1">
		...
		<c:forEach items="${viewAll }" var="list" varStatus="status">
			<tr>
				...
				<td><a href='concentration.do?myLectureNo=${list.myLectureNo}'>
					<img src="${ROOT}/resources/thumbnail/${thumbnail[status.index]}.png">
				</a></td>
				<td><a href='concentration.do?myLectureNo=${list.myLectureNo}'>${list.name}</a></td>
				<td>${list.episode}</td>
			</tr>
		</c:forEach>
	</table>	
	<div style="display: block; text-align: center;">	<!-- 아직 안고침 -->
